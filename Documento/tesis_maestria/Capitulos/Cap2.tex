...
\begin{equation}
\text{FWER} = P\left(\bigcup_{i=1}^K \{\text{rechazar } H_{0,i} | H_{0,i} \text{ verdadera}\}\right) \leq \sum_{i=1}^K P(\text{rechazar } H_{0,i} | H_{0,i} \text{ verdadera}) \leq \alpha_{\text{global}}
\end{equation}
