...
\item \textbf{Calibración y ajuste de hiperparámetros:} Cada modelo se optimiza siguiendo el procedimiento de dos etapas descrito en la Sección~\ref{sec:protocolo_optimizacion}. Brevemente, los hiperparámetros se seleccionan mediante validación cruzada en el conjunto de entrenamiento, y luego los parámetros conformales se calibran usando el conjunto de calibración dedicado.
